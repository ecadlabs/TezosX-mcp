    ...
    <div class="bg-amber-50 border border-amber-200 rounded p-3 mb-4">
      <div class="flex items-start gap-2">
        ...
        <p class="text-sm text-amber-700">
          Save this key now - you won't see it again. Update your MCP server configuration with the new spending key.
          This is <strong>not</strong> your wallets private key — it only authorizes the MCP server to spend from the contract, within the limits you configure.
        </p>
      </div>
    </div>
